...
if __name__ == "__main__":
    ...
    p1 = ParametrosPlanPago(
        monto_desembolso        = 1000.00,
        tasa_interes_anual      = 41.99 / 100.0,
        fecha_desembolso        = date(2026, 1, 14),
        num_cuotas              = 12,
        dias_gracia             = 0,
        tipo_periodo            = 1,           # Fecha Fija
        dia_fec_pago            = 14,
        fecha_primera_cuota     = date(2026, 2, 14),
        id_seguro_desgravamen   = 9,           # DESGRAVAMEN INDIVIDUAL (0.165%)
        id_plan_seguro          = None,        # Sin plan adicional
